...
import { getProfile, updateProfile, login, createRegister, register, createLogin, createReset-password, deleteProfile, logout } from './services/api';
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="rounded-2xl overflow-hidden" style={{ boxShadow: '0 10px 40px rgba(189, 22, 214, 0.2)' }}>
              <ImageWithFallback
                src={hotel?.image || process.env.REACT_APP_API_URL}
